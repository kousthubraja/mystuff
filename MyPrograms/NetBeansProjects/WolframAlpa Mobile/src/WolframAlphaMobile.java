 ...
 * @author Kousthub
 */
public class WolframAlphaMobile extends MIDlet implements CommandListener,Runnable{
    private String url;
    private Thread th;
    ...
    public WolframAlphaMobile(){
        form=new Form("WolframAlpha Mobile");
    ...
    void showabout(){
        about=new Form("About WolframAlpha Mobile");
