 ...
 * @author Kousthub
 */
public class NetTest extends MIDlet implements CommandListener,Runnable {
...
//GEN-LINE:|4-resumeMIDlet|1|4-postAction
    ...
    public void run()
    {
        try
                {
                    HttpConnection sc=(HttpConnection)Connector.open("http://"+textField.getString());
                    InputStream dis = sc.openInputStream();
                    long len=sc.getLength();
                    char ch;
                    
                    stringItem.setString(String.valueOf(len));
                    /*if(len!=-1) {
                              for(int i = 0;i<len;i++){
                    ...
                    String str=null;
                        ...
                        while ((ch = (char)dis.read()) != -1 && stringItem.size()<120)
                        {
                            stringItem.setString(stringItem.getString()+String.valueOf(ch));
                        }
                ...
                }catch(Exception e){stringItem.setString(e.getMessage());}
    }
    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == form) {//GEN-BEGIN:|7-commandAction|1|16-preAction
            if (command == exitCommand) {//GEN-END:|7-commandAction|1|16-preAction
                // write pre-action user code here
                exitMIDlet();//GEN-LINE:|7-commandAction|2|16-postAction
                // write post-action user code here
            } else if (command == itemCommand) {//GEN-LINE:|7-commandAction|3|19-preAction
...
//GEN-LINE:|7-commandAction|4|19-postAction
        ...
        // write post-action user code here
    }//GEN-BEGIN:|7-commandAction|6|25-postAction
    //</editor-fold>//GEN-END:|7-commandAction|6|25-postAction
    ...
    public Form getForm() {
        if (form == null) {//GEN-END:|13-getter|0|13-preInit
            ...
            form = new Form("form", new Item[] { getTextField(), getStringItem() });//GEN-BEGIN:|13-getter|1|13-postInit
    ...
    //<editor-fold defaultstate="collapsed" desc=" Generated Getter: itemCommand ">//GEN-BEGIN:|18-getter|0|18-preInit
    /**
     * Returns an initiliazed instance of itemCommand component.
     * @return the initialized component instance
     */
    public Command getItemCommand() {
        if (itemCommand == null) {//GEN-END:|18-getter|0|18-preInit
            // write pre-init user code here
            itemCommand = new Command("Item", Command.ITEM, 0);//GEN-LINE:|18-getter|1|18-postInit
            // write post-init user code here
    ...
    public TextField getTextField() {
        if (textField == null) {//GEN-END:|21-getter|0|21-preInit
            // write pre-init user code here
            textField = new TextField("textField", null, 32, TextField.ANY);//GEN-LINE:|21-getter|1|21-postInit
            // write post-init user code here
     ...
     * @return the initialized component instance
     */
    public TextField getStringItem() {
        if (stringItem == null) {//GEN-END:|22-getter|0|22-preInit
            // write pre-init user code here
            stringItem = new TextField("textField1", null, 128, TextField.ANY);//GEN-LINE:|22-getter|1|22-postInit
            // write post-init user code here
    ...
    public Command getItemCommand1() {
        if (itemCommand1 == null) {//GEN-END:|24-getter|0|24-preInit
            // write pre-init user code here
            itemCommand1 = new Command("Item", Command.SCREEN, 0);//GEN-LINE:|24-getter|1|24-postInit
            // write post-init user code here
