	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		OnItemClickListener itemClick = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v, int position,
				...
				String eventId = ob.getId();
				Intent intent = null;
				switch(ob.getType()){
					case Event.LECTURES: 	intent = new Intent(EventsMenu.this, Lectures.class);break;
					case Event.WORKSHOP:	intent = new Intent(EventsMenu.this, Workshop.class);break;
					case Event.EXHIBITION:	intent = new Intent(EventsMenu.this, Exhibition.class);break;
					default: return;
				}
