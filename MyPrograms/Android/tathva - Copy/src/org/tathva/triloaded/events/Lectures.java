...
public class Lectures extends Activity implements OnClickListener{
	...
	public void onClick(View btn) {
		...
		case R.id.scheduleButton:
				ScheduleWindow schedule = new ScheduleWindow(Lectures.this,lectureId);
				schedule.show(); 
				break;
