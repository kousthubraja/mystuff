		...
		new AsyncTask<Void, Void, Void>(){
			...
			protected Void doInBackground(Void... arg0) {
				try{
					...
					byte[] img1,img2,img3;
					img1=downloadImage("http://tri.comule.com/contentHTMLs/"+eventID+"_1.jpg");
					img2=downloadImage("http://tri.comule.com/contentHTMLs/"+eventID+"_2.jpg");
					img3=downloadImage("http://tri.comule.com/contentHTMLs/"+eventID+"_3.jpg");
